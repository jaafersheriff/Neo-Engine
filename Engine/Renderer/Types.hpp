...
namespace neo {
	namespace types {
		...
		// Lifted out of the texture namespace: shader buffers and image bindings describe their
		// contents with the same formats, so this is not a texture-only concept.
