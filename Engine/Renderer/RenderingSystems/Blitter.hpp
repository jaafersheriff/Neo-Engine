...
namespace neo {
	...
	inline void blit(
		...
		NEO_UNUSED(fg, vp, resourceManagers, srcHandle, dstHandle, srcImage, deps...);
		TRACY_ZONE();
		...
		// fg.pass(dstHandle, vp, blitShaderHandle, [srcHandle, dstHandle, srcImage, blitShaderHandle](const ResourceManagers& resourceManagers, const ECS&) {
		// 	TRACY_GPUN("Blit");
