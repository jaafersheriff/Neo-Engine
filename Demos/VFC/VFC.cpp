...
namespace VFC {
    ...
    void generateObjects(ECS& ecs, int amount) {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            Renderable renderable(ecs, meshData.mMesh, position, size);
            Material material;
    ...
    void Demo::init(ECS& ecs) {
        ...
        /* Ground plane */
        Renderable plane(ecs, Library::getMesh("quad").mMesh, glm::vec3(0.f), glm::vec3(30.f), glm::vec3(-util::PI / 2.f, 0.f, 0.f));
